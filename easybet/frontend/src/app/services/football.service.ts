...
export class FootballService {
  ...
  public readFileFootball(): void {
    let football = new FootballModel(data[0].date, data[0].leagueName, data[0].teamHome, data[0].teamGuest, data[0].odds);
    ...
    football = new FootballModel(data[3].date, data[3].leagueName, data[3].teamHome, data[3].teamGuest, data[3].odds);
    this.footballMatches.push(football);
    football = new FootballModel(data[4].date, data[4].leagueName, data[4].teamHome, data[4].teamGuest, data[4].odds);
    this.footballMatches.push(football);
    football = new FootballModel(data[5].date, data[5].leagueName, data[5].teamHome, data[5].teamGuest, data[5].odds);
    this.footballMatches.push(football);
